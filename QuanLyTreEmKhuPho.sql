...
-- 2. NguoiDung
-- ============================
INSERT INTO NguoiDung (HoTen, SDT, Email, MatKhau, VaiTro, NgayTao)
VALUES
(N'Nguyễn Văn A', '0909123456', 'a@gmail.com', '123', N'Admin', GETDATE()),
(N'Trần Thị B', '0909234567', 'b@gmail.com', '123', N'Tình nguyện viên', GETDATE()),
(N'Lê Văn C', '0909345678', 'c@gmail.com', '123', N'Phụ huynh', GETDATE()),
(N'Phạm Thị D', '0909456789', 'd@gmail.com', '123', N'Cán bộ', GETDATE()),
(N'Võ Văn E', '0909567890', 'e@gmail.com', '123', N'Tình nguyện viên', GETDATE());
...
-- 19. TreEm
-- ============================
INSERT INTO TreEm (HoTen, NgaySinh, GioiTinh, TonGiao, DanToc, QuocTich, TruongID, TinhTrang, KhuPhoID)
VALUES
(N'Bé Lan','2015-03-15',N'Nữ',N'Không',N'Kinh',N'Việt Nam',1,N'Khó khăn',1),
(N'Bé Tí','2013-02-20',N'Nam',N'Không',N'Kinh',N'Việt Nam',2,N'Bình thường',2),
(N'Bé Hoa','2016-04-10',N'Nữ',N'Phật giáo',N'Kinh',N'Việt Nam',3,N'Mồ côi',3),
(N'Bé Nam','2012-06-25',N'Nam',N'Không',N'Kinh',N'Việt Nam',4,N'Khó khăn',4),
(N'Bé Bình','2014-08-30',N'Nam',N'Không',N'Kinh',N'Việt Nam',5,N'Bình thường',5);
